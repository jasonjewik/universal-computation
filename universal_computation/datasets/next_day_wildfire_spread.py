...
class NextDayWildfireSpreadDataset(Dataset):
    def __init__(self, batch_size, patch_size=None, data_aug=True, *args, **kwargs):
        ...
        train_file_pattern = 'data/next_day_wildfire_spread/next_day_wildfire_spread_train*'
        eval_file_pattern = 'data/next_day_wildfire_spread/next_day_wildfire_spread_eval*'
        ...
        def _parse_fn(
            ...
            if (random_crop and center_crop):
                raise ValueError(
                    'Cannot have both random_crop and center_crop be True')
